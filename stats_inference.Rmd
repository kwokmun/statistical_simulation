...
Let's simulate a sampling distribution of the means for a normal distribution with mean = 5 and standard deviation = sqrt(0.6) with 1000 simulations. If we overlay the normal sampling distribution (in blue) over the exponential sampling distribution (in salmon colour), they approximate each other very well.
